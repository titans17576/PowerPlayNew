...
public class visionTest extends LinearOpMode
{
    ...
    public class cmyDetection extends OpenCvPipeline {
        ...
        public Mat processFrame(Mat input) {
            ...
            Core.inRange(frame, new Scalar(90, 50, 70), new Scalar(110, 255, 255), tempOutput);
            Imgproc.findContours(tempOutput, contours[0], hierarchies[0], Imgproc.RETR_TREE,
                    Imgproc.CHAIN_APPROX_SIMPLE);

            Core.inRange(frame, new Scalar(150, 50, 70), new Scalar(170, 255, 255), tempOutput);
            Imgproc.findContours(tempOutput, contours[1], hierarchies[1], Imgproc.RETR_TREE,
                    Imgproc.CHAIN_APPROX_SIMPLE);

            Core.inRange(frame, new Scalar(50, 50, 70), new Scalar(85, 255, 255), tempOutput);
                ...
                if (contours[0].size() + contours[1].size() + contours[2].size() > 0) {
                    ...
                    switch (maxInd) {
                        ...
                        case 2:
                            ...
                            break;
                        default:
                            telemetry.addData("maxind", maxInd);
