...
public class visionTest extends LinearOpMode
{
    ...
    public class cmyDetection extends OpenCvPipeline {
        ...
        public Mat processFrame(Mat input) {
            ...
            Core.inRange(frame, new Scalar(80, 50, 70), new Scalar(100, 255, 255), tempOutput);
            Imgproc.findContours(tempOutput, contours[0], hierarchies[0], Imgproc.RETR_TREE,
                    Imgproc.CHAIN_APPROX_SIMPLE);

            Core.inRange(frame, new Scalar(140, 50, 70), new Scalar(160, 255, 255), tempOutput);
            Imgproc.findContours(tempOutput, contours[1], hierarchies[1], Imgproc.RETR_TREE,
                    Imgproc.CHAIN_APPROX_SIMPLE);

            Core.inRange(frame, new Scalar(20, 50, 70), new Scalar(40, 255, 255), tempOutput);
